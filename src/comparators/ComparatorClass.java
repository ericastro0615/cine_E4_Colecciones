...
public class ComparatorClass {
   public Comparator <PeliculaClass> pelisDuracionAsc = new Comparator<PeliculaClass> () {
        @Override
   ...
   public Comparator <PeliculaClass> pelisDuracionDesc = new Comparator<PeliculaClass> () {
       @Override
   ...
   public Comparator <PeliculaClass> pelisTitulosAlf = new Comparator<PeliculaClass> () {
       @Override
       public int compare(PeliculaClass o1, PeliculaClass o2) {
